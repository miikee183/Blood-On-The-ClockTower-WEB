...
const EDICIONES = {
    TB: [
        { nombre: "Diablillo", tipo: "demonio", efecto: "none", info: "Puede matar a un jugador todas las noches, sé puede matar así mismo uno de sus esbirros se convierte en el demonio.", emoji: "🔱" },
        ...
        { nombre: "Espía", tipo: "esbirro", efecto: "none", info: "Podrá ver todas las noches el grimorio. (Ve los roles de cada uno) es percibido como pueblo para los demás jugadores (ej: puede morir nominando a la virgen, no será detectado por el empático, por el chef ni por el investigador).", emoji: "👁️" },
        { nombre: "Mujer Escarlata", tipo: "esbirro", efecto: "none", info: "Si el demonio es eliminado, pasa a ser demonio si al menos hay 5 jugadores vivos.", emoji: "💋" },
        ...
        { nombre: "Chef", tipo: "pueblerino", efecto: "none", info: "En la primera noche sabrá si hay roles malos juntos (si hay 2 juntos se le dirá 1 si hay 3 se le dirá 2 y si hay 2 parejas separadas se le dirá igual 2).", emoji: "🧑‍🍳" },
        ...
        { nombre: "Monje", tipo: "pueblerino", efecto: "Protegido", info: "Todas las noches elige a un jugador, ese juegador es inmune a ataques de demonio.", emoji: "✝️" },
        { nombre: "Guardián de cuervos", tipo: "pueblerino", efecto: "none", info: "Si muere por el demonio, esa misma noche elige a alguien y sabe su rol.", emoji: "🐦‍⬛" },
        ...
        { nombre: "Recluso", tipo: "forastero", efecto: "none", info: "Puede ser identificado tanto como demonio, esbirro, forastero o pueblo para todos los jugadores. (ej si el narrador quiere puede ser muerte por el exterminador ya que se identifica como demonio).", emoji: "🕯️" },
    ...
    BMR: [
        ...
        { nombre: "Camarera", tipo: "pueblerino", efecto: "CamareraInfo", info: "Elige a 2 jugadores y sabará si ellos se levantaron la misma noche que ella.", emoji: "🧹" },
        { nombre: "Marinero", tipo: "pueblerino", efecto: "Embriaguez", info: "Borracho e inmortal.", emoji: "⚓" },
        ...
        { nombre: "Matón", tipo: "forastero", efecto: "Matón-Borracho", info: "Cambia de bando si lo eligen.", emoji: "👊" },
        { nombre: "Lunático", tipo: "forastero", efecto: "none", info: "Cree que es el demonio, el narrador le da nombres de esbirros falsos y cree que está matando.", emoji: "🌀" },
